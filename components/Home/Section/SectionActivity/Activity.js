      ...
      <Container className = 'py-5'>
        <Row className = 'align-items-end justify-content-between'>
          ...
          <Col lg = {5} className = 'd-flex justify-content-end gap-3'>
            <Button 
                className = 'swiper-prev fs-5 text-center rounded-circle' 
                style = {{ 
                  backgroundColor: "#63A8E7", 
                  border: "none" 
                }}
              >
                <BsChevronLeft className = 'me-1 my-2' />
              </Button>
              <Button 
                className = 'swiper-next fs-5 text-center rounded-circle' 
                style = {{  
                  backgroundColor: "#63A8E7", 
                  border: "none" 
                }}
              >
                <BsChevronRight className = 'ms-1 my-2' />
              </Button>
          </Col>
